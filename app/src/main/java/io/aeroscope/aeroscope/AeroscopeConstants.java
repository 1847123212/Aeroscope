...
/************************************ APPLICATION PARAMETERS **************************************/
    ...
    final static boolean MSG_FROM_AEROSCOPE = false;
    final static boolean CMD_TO_AEROSCOPE = true;
...
/**************************************** AEROSCOPE PROBE *****************************************/
    ...
    final static byte[] defaultFpgaRegisters = { // unallocated values are set to 0x00
